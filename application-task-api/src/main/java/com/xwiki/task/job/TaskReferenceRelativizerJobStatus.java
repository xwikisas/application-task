...
/**
 * The status associated with the job created by {@link TaskReferenceRelativizerJobRequest}.
 *
 * @version $Id$
 * @since 3.5.2
 */
public class TaskReferenceRelativizerJobStatus extends DefaultJobStatus<TaskReferenceRelativizerJobRequest>
{
     ...
     */
    public TaskReferenceRelativizerJobStatus(TaskReferenceRelativizerJobRequest request, JobStatus parentJobStatus,
        ObservationManager observationManager, LoggerManager loggerManager)
    {
        super("taskmanager.relativizetaskreference", request, parentJobStatus, observationManager, loggerManager);
    }
}
